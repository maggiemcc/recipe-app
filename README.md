...
- This project was created using Vanilla JS on the Frontend, uses MongoDB for the database, and uses [TheMealDB API](https://www.themealdb.com/). It's also being hosted live on [Heroku](https://whispering-reef-92142.herokuapp.com/).
